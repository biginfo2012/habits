...
import { PaperClipIcon, UploadIcon, DotsHorizontalIcon } from "@heroicons/react/solid";


export const ChooseImageComponent = (props) => {
  const { id, 
          title, 
          firstLine, 
          secondLine, 
      ...
      <Card.Body>
        ...
        <div className="d-flex align-items-center">
          <div style={{width:'70%'}} className="me-3">
            <Image style={{maxHeight:300, width:'auto', borderRadius:20}} fluid src={photo} />
          </div>
              ...
              <div className="file-field">
                <div className="d-flex justify-content-xl-center ms-xl-3">
                  <div className="d-flex">
                    ...
                    <input id={id} type="file" accept=".png,.jpg,.jpeg,.gif" onChange={(e)=>onImageChange(e)}/>

...
import { UsersTable } from "components/habits/UsersTable";
...
/*
  ...
  return (
      ...
      <div className="table-settings mb-4">
        <Row className="justify-content-between align-items-center">
          <Col xs={9} lg={8} className="d-md-flex">
            ...
            <Form.Select value={filterValue} className="fmxw-200 d-none d-md-inline" onChange={(e) => {setFilterValue(e.target.value)}}>
    ...
    {users &&
      <UsersTable
        users={users.filter(u => u.show).filter(u => (filterValue === "" || filterValue === "all" || u.role === filterValue))}
        refresh={refresh}
